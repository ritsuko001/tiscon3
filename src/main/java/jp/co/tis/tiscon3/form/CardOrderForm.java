...
public class CardOrderForm extends FormBase {
    ...
    @Size(max = 8)
    @Pattern(regexp = "^([0-9]{3}-[0-9]{4})?$",message="半角数字と-で入力してください")
    ...
    @Size(max = 13,message="")
    @Pattern(regexp = "^(0[0-9]{1,3}-[0-9]{2,4}-[0-9]{4})?$",message="半角数字と-で入力してください")
    ...
    @Size(max = 6,message="")
    @Pattern(regexp = "[0-9]*",message="半角数字と-で入力してください")
